...
class LoginController: UIViewController {
    ...
    private let logoContainerView: UIView = {
        ...
        container.backgroundColor = UIColor.rgb(red: 62, green: 12, blue: 94)
    ...
    private let loginButton: UIButton = {
        ...
        button.backgroundColor = UIColor.rgb(red: 62, green: 12, blue: 94)
    ...
    @objc private func handleLogin() {
        ...
        loginButton.isEnabled = false
        loginButton.backgroundColor = UIColor.rgb(red: 62, green: 12, blue: 94)
